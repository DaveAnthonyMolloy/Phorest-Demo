...
describe("Verify $50 To Me Functionality", () => {
  ...
  it("Check error messages for First Name field", () => {
    //repeatedly enter char to exceed character limit. Set delay to 0 to avoid longer typing
    cy.get(giftCardPage.firstNameField).type("a".repeat(50), { delay: 0 });

    //error messages is speculated as it's not listed in code, nor do i have documentation
    cy.get(giftCardPage.firstNameError).should(
      "have.text",
    ...
    cy.get(giftCardPage.firstNameError).should("have.text", "Required");

    cy.get(giftCardPage.firstNameField).type("1");
  ...
  it("Check error messages for Last Name field", () => {
    cy.get(giftCardPage.lastNameField).type("a".repeat(50), { delay: 0 });

    //error messages is speculated as it's not listed in code, nor do i have documentation
    cy.get(giftCardPage.lastNameError).should(
      "have.text",
      "Max Characters exceeded"
    );
    ...
    cy.get(giftCardPage.lastNameError).should("have.text", "Required");

    cy.get(giftCardPage.lastNameField).type("1");
